...
function styleTask(elmnt, day) {
	...
	elmnt.style.padding = "20px 35px 20px 20px";
	elmnt.style.borderRadius = "15px 15px 15px 15px";
	if (day >= 7) {
		elmnt.style.backgroundColor = "rgba(128, 128, 128, 0.3)";
	}
	if (day < 7 && day >= 3) {
		elmnt.style.backgroundColor = "rgba(255, 255, 0, 0.3)";
	}
	if (day < 3 && day >= 1) {
		elmnt.style.backgroundColor = "rgba(255, 0, 0, 0.3)";
	}	
	return elmnt;
}
